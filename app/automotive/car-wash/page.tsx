...
const services=["Exterior wash","Interior cleaning","Vacuum & finishing","SUV and saloon service","Complete vehicle cleaning"];

export default function ServicePage(){
 const whatsapp="https://api.whatsapp.com/send?phone=96878967229&text="+encodeURIComponent("Hello K&Z Elite Business, I need a quote for CAR WASH. Please send me more details.");
 return <main className="kz-dept-page">
  <section className="kz-dept-hero">
   ...
   <div className="kz-dept-hero-inner"><div className="kz-dept-icon">≈</div><span>K&Z AUTOMOTIVE SERVICE DEPARTMENT</span><h1>CAR WASH</h1><p>Exterior • Interior • Complete Cleaning</p>
