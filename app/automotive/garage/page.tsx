...
const services=["Mechanical inspection & repair","Electrical diagnostics & repair","AC inspection & service","Engine & suspension support","General maintenance"];

export default function ServicePage(){
 const whatsapp="https://api.whatsapp.com/send?phone=96878967229&text="+encodeURIComponent("Hello K&Z Elite Business, I need a quote for GARAGE & MAINTENANCE. Please send me more details.");
 return <main className="kz-dept-page">
  <section className="kz-dept-hero">
   ...
   <div className="kz-dept-hero-inner"><div className="kz-dept-icon">⚙</div><span>K&Z AUTOMOTIVE SERVICE DEPARTMENT</span><h1>GARAGE & MAINTENANCE</h1><p>Mechanical • Electrical • AC • General Maintenance</p>
