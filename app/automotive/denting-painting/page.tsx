...
const services=["Dent correction","Body repair","Panel painting","Scratch & paint repair","Exterior finish restoration"];

export default function ServicePage(){
 const whatsapp="https://api.whatsapp.com/send?phone=96878967229&text="+encodeURIComponent("Hello K&Z Elite Business, I need a quote for DENTING & PAINTING. Please send me more details.");
 return <main className="kz-dept-page">
  <section className="kz-dept-hero">
   ...
   <div className="kz-dept-hero-inner"><div className="kz-dept-icon">▰</div><span>K&Z AUTOMOTIVE SERVICE DEPARTMENT</span><h1>DENTING & PAINTING</h1><p>Body Repair • Dent Correction • Painting</p>
