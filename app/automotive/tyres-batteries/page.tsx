...
const services=["Tyre replacement & fitting","Battery testing & replacement","Wheel and tyre support","Multiple brands and sizes","Vehicle-specific recommendations"];

export default function ServicePage(){
 const whatsapp="https://api.whatsapp.com/send?phone=96878967229&text="+encodeURIComponent("Hello K&Z Elite Business, I need a quote for TYRES & BATTERIES. Please send me more details.");
 return <main className="kz-dept-page">
  <section className="kz-dept-hero">
   ...
   <div className="kz-dept-hero-inner"><div className="kz-dept-icon">◉</div><span>K&Z AUTOMOTIVE SERVICE DEPARTMENT</span><h1>TYRES & BATTERIES</h1><p>Tyres • Batteries • Fitting • Replacement</p>
