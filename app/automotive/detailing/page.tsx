...
const services=["Exterior polishing","Interior deep detailing","Paint finish enhancement","Dashboard & trim cleaning","Full vehicle detailing"];

export default function ServicePage(){
 const whatsapp="https://api.whatsapp.com/send?phone=96878967229&text="+encodeURIComponent("Hello K&Z Elite Business, I need a quote for POLISHING & DETAILING. Please send me more details.");
 return <main className="kz-dept-page">
  <section className="kz-dept-hero">
   ...
   <div className="kz-dept-hero-inner"><div className="kz-dept-icon">◆</div><span>K&Z AUTOMOTIVE SERVICE DEPARTMENT</span><h1>POLISHING & DETAILING</h1><p>Polishing • Interior Detailing • Exterior Care</p>
