...
const services=["Automotive window tinting","Different tint options","Clean professional installation","Old tint removal support","Appearance and privacy upgrades"];

export default function ServicePage(){
 const whatsapp="https://api.whatsapp.com/send?phone=96878967229&text="+encodeURIComponent("Hello K&Z Elite Business, I need a quote for WINDOW TINTING. Please send me more details.");
 return <main className="kz-dept-page">
  <section className="kz-dept-hero">
   ...
   <div className="kz-dept-hero-inner"><div className="kz-dept-icon">◐</div><span>K&Z AUTOMOTIVE SERVICE DEPARTMENT</span><h1>WINDOW TINTING</h1><p>Professional Tinting • Privacy • Appearance</p>
