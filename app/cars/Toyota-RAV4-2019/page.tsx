...
export default function ToyotaRAV4Page() {
  ...
  const whatsappLink =
    "https://api.whatsapp.com/send?phone=96878967229&text=Hello%20K%26Z%20Elite%20Business,%20I%20am%20interested%20in%20the%20Toyota%20RAV4%202019.%20Please%20send%20me%20more%20details.";
  ...
  const details = [
    ...
    ["Mileage", "213,206 KM"],
    ["Mulkiya", "Valid Until 25 March 2027"],
    ...
    >
      <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
        ...
        >
          <img
            src={images[current]}
            alt={`Toyota RAV4 2019 photo ${current + 1}`}
            style={{
              width: "100%",
        ...
        >
          {images.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Toyota RAV4 2019 thumbnail ${index + 1}`}
                style={{
                  width: "105px",
                  height: "72px",
                  objectFit: "cover",
        ...
        >
          ...
          <p style={{ margin: "7px 0 0", color: "#c9d3df" }}>
            Contact us for finance options and complete
            vehicle details.
          </p>
        </div>
        ...
        >
          <h2 style={{ marginTop: 0, fontSize: "28px" }}>
            Interested in this Toyota RAV4?
          </h2>

          <p style={{ color: "#bac7d6", marginBottom: "22px" }}>
            Contact K&Z Elite Business for further details.
          </p>
