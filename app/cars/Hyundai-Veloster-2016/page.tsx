...
const images = [
  ...
  "/cars/Hyundai-Veloster-2016/4.jpg",
  "/cars/Hyundai-Veloster-2016/5.jpg",
  "/cars/Hyundai-Veloster-2016/6.jpg",
  "/cars/Hyundai-Veloster-2016/7.jpg",
  "/cars/Hyundai-Veloster-2016/8.jpg",
  "/cars/Hyundai-Veloster-2016/9.jpg",
  "/cars/Hyundai-Veloster-2016/10.jpg",
  "/cars/Hyundai-Veloster-2016/11.jpg",
  "/cars/Hyundai-Veloster-2016/12.jpg",
];

export default function HyundaiVelosterPage() {
  ...
  const whatsappLink =
    "https://api.whatsapp.com/send?phone=96878967229&text=Hello%20K%26Z%20Elite%20Business,%20I%20am%20interested%20in%20the%20Hyundai%20Veloster%202016.%20Please%20send%20me%20the%20price%20and%20more%20details.";
    ...
    >
      <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          >
            GCC Spec • 1.6L • Full Option • Panoramic Sunroof
          </p>
        </div>
        ...
        >
          <img
            src={images[current]}
            alt={`Hyundai Veloster 2016 photo ${current + 1}`}
            style={{
              width: "100%",
        ...
        >
          {images.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Hyundai Veloster thumbnail ${index + 1}`}
                style={{
                  width: "105px",
                  height: "72px",
                  objectFit: "cover",
        ...
        >
          <h2 style={{ marginTop: 0, fontSize: "28px" }}>
            Interested in this Hyundai Veloster?
          </h2>
