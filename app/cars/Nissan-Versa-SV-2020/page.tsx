...
const images = [
  ...
  "/cars/Nissan-Versa-SV-2020/4.jpg",
  "/cars/Nissan-Versa-SV-2020/5.jpg",
  "/cars/Nissan-Versa-SV-2020/6.jpg",
  "/cars/Nissan-Versa-SV-2020/7.jpg",
  "/cars/Nissan-Versa-SV-2020/8.jpg",
  "/cars/Nissan-Versa-SV-2020/9.jpg",
];

export default function NissanVersaSV2020Page() {
  ...
  const whatsappLink =
    "https://api.whatsapp.com/send?phone=96878967229&text=Hello%20K%26Z%20Elite%20Business,%20I%20am%20interested%20in%20the%20Nissan%20Versa%20SV%202020.%20Please%20send%20me%20the%20price%20and%20more%20details.";
    ...
    >
      <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
        ...
        >
          <img
            src={images[current]}
            alt={`Nissan Versa SV 2020 photo ${current + 1}`}
            style={{
              width: "100%",
        ...
        >
          {images.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Nissan Versa SV 2020 thumbnail ${index + 1}`}
                style={{
                  width: "105px",
                  height: "72px",
                  objectFit: "cover",
        ...
        >
          <h2 style={{ marginTop: 0, fontSize: "28px" }}>
            Interested in this Nissan Versa SV?
          </h2>
