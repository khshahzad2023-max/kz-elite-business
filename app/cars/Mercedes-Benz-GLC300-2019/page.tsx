...
const images = [
  ...
  "/cars/Mercedes-Benz-GLC300-2019/4.jpg",
  "/cars/Mercedes-Benz-GLC300-2019/5.jpg",
  "/cars/Mercedes-Benz-GLC300-2019/6.jpg",
  "/cars/Mercedes-Benz-GLC300-2019/7.jpg",
  "/cars/Mercedes-Benz-GLC300-2019/8.jpg",
  "/cars/Mercedes-Benz-GLC300-2019/9.jpg",
];

export default function MercedesGLC300Page() {
  ...
  const whatsappLink =
    "https://api.whatsapp.com/send?phone=96878967229&text=Hello%20K%26Z%20Elite%20Business,%20I%20am%20interested%20in%20the%20Mercedes-Benz%20GLC%20300%202019.%20Please%20send%20me%20the%20price%20and%20more%20details.";

  const details = [
    ["Model", "2019"],
    ["Specification", "US Specs"],
    ["Mileage", "190,000 KM"],
    ["Feature", "Panoramic Sunroof"],
    ["Interior", "Premium Leather"],
    ["Seats", "Memory Seats"],
    ["Service", "Full-Service Record"],
    ...
    >
      <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          >
            US Specs • Premium Interior • Panoramic Sunroof
          </p>
        </div>
        ...
        >
          <img
            src={images[current]}
            alt={`Mercedes-Benz GLC 300 2019 photo ${current + 1}`}
            style={{
              width: "100%",
        ...
        >
          {images.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Mercedes-Benz GLC 300 thumbnail ${index + 1}`}
                style={{
                  width: "105px",
                  height: "72px",
                  objectFit: "cover",
        ...
        >
          <h2 style={{ marginTop: 0, fontSize: "28px" }}>
            Interested in this Mercedes-Benz GLC 300?
          </h2>
