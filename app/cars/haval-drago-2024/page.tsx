...
const images = [
  ...
  "/cars/haval-drago-2024/4.jpg",
  "/cars/haval-drago-2024/5.jpg",
  "/cars/haval-drago-2024/6.jpg",
  "/cars/haval-drago-2024/7.jpg",
];

export default function HavalDragoPage() {
  ...
  const whatsappLink =
    "https://api.whatsapp.com/send?phone=96878967229&text=Hello%20K%26Z%20Elite%20Business,%20I%20am%20interested%20in%20the%20Haval%20Dargo%202024.%20Please%20send%20me%20the%20price%20and%20more%20details.";
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          >
            2.0L Turbo • 4WD • GCC Oman Showroom
          </p>
        </div>
        ...
        >
          <img
            src={images[current]}
            alt={`Haval Dargo 2024 photo ${current + 1}`}
            style={{
              width: "100%",
        ...
        >
          {[
            ...
            ["Specification", "GCC • Oman Showroom"],
            ["Mulkiya", "Valid until 02 August 2027"],
        ...
        >
          ...
          >
            Interested in this Haval Dargo?
          </h2>
