...
const images = [
  ...
  "/cars/Hyundai-Santa-Fe-2015/4.jpg",
  "/cars/Hyundai-Santa-Fe-2015/5.jpg",
  "/cars/Hyundai-Santa-Fe-2015/6.jpg",
];
...
export default function HyundaiSantaFePage() {
  ...
  const whatsappLink =
    "https://api.whatsapp.com/send?phone=96878967229&text=Hello%20K%26Z%20Elite%20Business,%20I%20am%20interested%20in%20the%20Hyundai%20Santa%20Fe%202015.%20Please%20send%20me%20the%20price%20and%20more%20details.";
    ...
    >
      <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
        ...
        >
          <img
            src={images[current]}
            alt={`Hyundai Santa Fe 2015 photo ${current + 1}`}
            style={{
              width: "100%",
        ...
        >
          {images.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Hyundai Santa Fe thumbnail ${index + 1}`}
                style={{
                  width: "105px",
                  height: "72px",
                  objectFit: "cover",
        ...
        >
          <h2 style={{ marginTop: 0, fontSize: "28px" }}>
            Interested in this Hyundai Santa Fe?
          </h2>
