...
const images = [
  ...
  "/cars/Ford-Explorer-2016/4.jpg",
  "/cars/Ford-Explorer-2016/5.jpg",
  "/cars/Ford-Explorer-2016/6.jpg",
  "/cars/Ford-Explorer-2016/7.jpg",
  "/cars/Ford-Explorer-2016/8.jpg",
];
...
export default function FordExplorerPage() {
  ...
  const whatsappLink =
    "https://api.whatsapp.com/send?phone=96878967229&text=Hello%20K%26Z%20Elite%20Business,%20I%20am%20interested%20in%20the%20Ford%20Explorer%202016.%20Please%20send%20me%20the%20price%20and%20more%20details.";

  const details = [
    ["Model", "2016"],
    ["Specification", "USA Specs"],
    ["Engine", "3.5L V6"],
    ["Drive", "4WD"],
    ...
    ["Option", "Full Option"],
    ["Mulkiya", "Valid till 3 March 2027"],
    ...
    >
      <div style={{ maxWidth: "1150px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "25px" }}>
          ...
          >
            USA Specs • 3.5L V6 • 4WD • 7 Seater
          </p>
        </div>
        ...
        >
          <img
            src={images[current]}
            alt={`Ford Explorer 2016 photo ${current + 1}`}
            style={{
              width: "100%",
        ...
        >
          {images.map((image, index) => (
            ...
            >
              <img
                src={image}
                alt={`Ford Explorer thumbnail ${index + 1}`}
                style={{
                  width: "105px",
                  height: "72px",
                  objectFit: "cover",
        ...
        >
          <h2 style={{ marginTop: 0, fontSize: "28px" }}>
            Interested in this Ford Explorer?
          </h2>
