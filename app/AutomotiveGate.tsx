...
export default function AutomotiveGate(){
  ...
  return <div className={"auto-gate "+(open?"is-open":"")}>
    <div className="gate-reveal">
      ...
      <div className="gate-links"><Link href="/cars">Browse Cars</Link><Link href="/sell-your-car">Sell Your Car</Link><Link href="/automotive-services">Automotive Services</Link></div>
    </div>
